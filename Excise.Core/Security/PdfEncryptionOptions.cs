...
/// <see cref="Excise.Core.Writing.PdfDocumentWriter"/> and
/// <c>Excise.Core.Security.PdfStandardSecurityEncryptor</c> (internal) for the
...
/// <summary>
/// Encryption intent for <see cref="Excise.Core.Writing.PdfDocumentWriter"/>:
...
public sealed class PdfEncryptionOptions
{
    ...
    /// in <c>/P</c> and the encrypted <c>/Perms</c> field; excise does not
