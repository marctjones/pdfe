...
public class RecentFilesService
{
    ...
    /// source-generated <see cref="ExciseJsonContext"/> can reference it.
    /// </summary>
    ...
    public ObservableCollection<RecentFileEntry> Load()
    {
        ...
        try
        {
            ...
            var data = JsonSerializer.Deserialize(json, ExciseJsonContext.Default.RecentFilesData);
    ...
    public void Save(IEnumerable<RecentFileEntry> entries)
    {
        ...
        try
        {
            ...
            var json = JsonSerializer.Serialize(data, ExciseJsonContext.Default.RecentFilesData);
