...
/// <summary>
/// Public-API gate for the packable viewer libraries <c>Excise.Avalonia</c> and
/// <c>Excise.Rendering</c> (issue #384 — the DX/stability treatment #383 gave the
...
{
    [Fact]
    public void ExciseAvalonia_PublicApi_MatchesApprovedBaseline()
        => AssertPublicApi(typeof(global::Excise.Avalonia.Controls.PdfViewerControl), "Excise.Avalonia.approved.txt");

    [Fact]
    public void ExciseRendering_PublicApi_MatchesApprovedBaseline()
        => AssertPublicApi(typeof(global::Excise.Rendering.SkiaRenderer), "Excise.Rendering.approved.txt");
