...
public class QpdfReferenceToolTests
{
    ...
    // NOT validate against an empty password (confirmed against both pdfe's
    // own decrypt handler and qpdf: both reject it, tracked as pdfe#324 for
    ...
    public void Decrypt_WithEmptyUserPassword_ProducesAReadablePlaintextFile()
    {
        ...
        try
        {
            ...
            // empty password and stripping /Encrypt — not pdfe reading its
            // own output.
