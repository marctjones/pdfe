...
namespace Excise.Benchmarks;

/// <summary>
/// Core excise pipeline benchmarks (#344): parse, render, and text-extract on a
/// representative generated document. Run via <c>scripts/run-benchmarks.sh</c>.
/// These track excise-vs-excise regressions over time; see the project file for the
/// planned cross-library comparison.
/// </summary>
[MemoryDiagnoser]
public class ExciseBenchmarks
{
    [Params(1, 10)]
