...
///
/// pdfe enforces ISO 32000-2 Table 22 permissions at the ACTION layer: each
...
/// redaction is pdfe's core security purpose, and a document author's
...
partial class Program
{
    ...
    static Option<bool> CreateIgnorePermissionsOption() => new("--ignore-permissions")
    {
        Description = "Proceed even when the document's /P permission flags deny this action. " +
            "Explicit override for legitimate use — e.g. you are the document owner (pdfe cannot " +
