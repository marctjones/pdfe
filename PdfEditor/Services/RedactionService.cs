...
/// <summary>
/// GUI-facing redaction orchestrator. A thin shell over Pdfe.Core:
...
/// <c>PdfEditor.Tests.Security.ContentRemovalVerificationTests</c> pin
/// this property.
/// </remarks>
public class RedactionService
{
    ...
    private static void AppendBlackRectangle(PdfPage page, PdfRectangle rect)
    {
        ...
        page.SetContentStream(new Pdfe.Core.Content.ContentStream(ops));
    }
}
