...
public partial class MainWindowViewModel
{
    ...
    /// (headless tests have none — see <c>PdfEditor.csproj</c>'s
    /// <c>InternalsVisibleTo</c> for <c>PdfEditor.Tests</c>).
    /// </remarks>
